...
-- checking if local /spell directory exists.
...
local full_path = cwd .. '/spell'

local base_dir_for_spell
-- Check if the directory exists
if directory_exists(full_path) then
  base_dir_for_spell = vim.fn.getcwd()
else
  base_dir_for_spell = vim.fn.stdpath 'config'
end
...
local Dictionary_file = {
  ['pt-BR'] = { base_dir_for_spell .. '/spell/dictionary.txt' }, -- there is another way to find ~/.config/nvim ?
}
local DisabledRules_file = {
  ['pt-BR'] = { base_dir_for_spell .. '/spell/disable.txt' }, -- there is another way to find ~/.config/nvim ?
}
local FalsePositives_file = {
  ['pt-BR'] = { base_dir_for_spell .. '/spell/false.txt' }, -- there is another way to find ~/.config/nvim ?
}
