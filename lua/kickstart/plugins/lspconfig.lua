    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>~b', require('telescope.builtin').lsp_document_symbols, '[~]ymbols in [B]uffer')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('<leader>~w', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[~]ymbols in [W]orkspace')
